...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position,  View convertView, ViewGroup parent) {
        ...
        TextView magnitudeView = (TextView) v.findViewById(R.id.mag);
        // Format the magnitude to show 1 decimal place
        String formattedMagnitude = formatMagnitude(text.getMag());
        ...
        int magnitudeColor = getMagnitudeColor(text.getMag());

        // Set the color on the magnitude circle
        magnitudeCircle.setColor(magnitudeColor);

        String currentlocation=text.getCity();
        ...
        TextView primaryLocationView = (TextView) v.findViewById(R.id.primary_location);
        primaryLocationView.setText(primaryLocation);

        TextView locationOffsetView = (TextView) v.findViewById(R.id.location_offset);
